...
def apply_theme() -> None:
    st.markdown(
        ...
        .block-container { padding-top: 1.9rem; max-width: 1420px; }
        ...
        .metric-card { background:linear-gradient(180deg,#0e1a2a,#091422); border:1px solid var(--line); border-radius:8px; padding:18px; min-height:136px; }
        ...
        .status-pill { display:inline-flex; align-items:center; gap:8px; padding:9px 14px; border-radius:8px; border:1px solid var(--line); background:#0e1a2a; }
